...
(function() {
  var isBoolean, isFunction, isNullOrUndefined, k, namespace, thisNamespaceObjectContainer, toIntegerFromOctalRepresenation, v, _fs, _path, _root,
    __slice = [].slice,
  ...
  namespace(thisNamespaceObjectContainer, 'Util.System.IO', function(exports) {
    ...
    return exports.FileInfo = (function(_super) {
      ...
      FileInfo.prototype.CreateSync = function(mode) {
        var ex, success;
        mode = toIntegerFromOctalRepresenation(mode);
        if (!this.exists) {
          success = true;
