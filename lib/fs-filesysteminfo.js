...
(function() {
  ...
  namespace(thisNamespaceObjectContainer, 'Util.System.IO', function(exports) {
    ...
    exports.DirectoryInfo = (function(_super) {
      ...
      DirectoryInfo.prototype.Create = function(mode) {
        var ex, success;
      ...
      DirectoryInfo.prototype.CreateSubdirectory = function(path, mode) {
        var subdirectory;
        ...
        if (!subdirectory.exists) {
          subdirectory.Create(mode);
        }
        return subdirectory;
      };

      DirectoryInfo.prototype.EnumerateFileSystemInfos = function(fnSearchFilter, searchSubdirectories) {
